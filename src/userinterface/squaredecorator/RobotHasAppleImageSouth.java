...
public class RobotHasAppleImageSouth extends SquareDecorator
{
    private BufferedImage image;
    
    public RobotHasAppleImageSouth(Render render)
    {
        super(render);
        
        try
        {
            this.image = ImageIO.read(new File("images//android_with_apple_big_s.png"));
        } 
        catch (IOException e)
        {
            e.printStackTrace();
