...
public class RobotHasAppleImageEast extends SquareDecorator
{
    private BufferedImage image;
    
    public RobotHasAppleImageEast(Render render)
    {
        super(render);
        
        try
        {
            this.image = ImageIO.read(new File("images//android_with_apple_big_e.png"));
        } 
        catch (IOException e)
        {
            e.printStackTrace();
