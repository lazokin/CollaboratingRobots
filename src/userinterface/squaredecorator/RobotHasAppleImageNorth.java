...
public class RobotHasAppleImageNorth extends SquareDecorator
{
    private BufferedImage image;
    
    public RobotHasAppleImageNorth(Render render)
    {
        super(render);
        
        try
        {
            this.image = ImageIO.read(new File("images//android_with_apple_big_n.png"));
        } 
        catch (IOException e)
        {
            e.printStackTrace();
